...
namespace Server
{
    class Indexer
    {
        ...
        private static string[] ExcludedWords = File.ReadAllText("indexer-assets/stop_words.txt").Split(new char[] { '\r', '\n' }, StringSplitOptions.RemoveEmptyEntries);
        ...
        public void CreateIndex()
        {
            ...
            else
            {
                ...
                this.invertedIndex = JsonConvert.DeserializeObject<ConcurrentDictionary<string, ConcurrentQueue<string>>>(File.ReadAllText("indexer-assets/savedIndex.txt"));
            }
        }
